...
export const Sidebarcontent = () => {
  ...
  const SortRating = Data.watches.filter((data) => {
    ...
    const SearchBar = data.manufacturer.includes(filters.Name) 
    return meetsStarsCriteria && meetsRangeCriteria && meetsCategoryCriteria && SearchBar;
  })
